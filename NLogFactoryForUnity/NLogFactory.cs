    ...
    public static class NLogFactory
    {
        ...
        public static NLog.Logger GetLogger(string name, string nlogConfigFile, Dictionary<string, object> eventProperties)
        {
            ...
            lock (locker)
            {
                ...
                {
                    LogManager.Configuration = new XmlLoggingConfiguration(nlogConfigFile, false);
                }
            }
        ...
        public static NLog.Logger GetLogger(Action<NLog.Config.LoggingConfiguration> configure)
        {
            // configure if not configured
            lock (locker)
            {
